...
class TestOpenTargets(unittest.TestCase):
    ...
    def test_opentargets_no_limit(self):
        test = "test_opentargets_no_limit"
        expected_result = ot_dict[test]["expected_result"]
        result_to_test = opentargets(**ot_dict[test]["args"])
        # If result is a DataFrame, convert to list
        if isinstance(result_to_test, pd.DataFrame):
    ...
    def test_opentargets_no_specified_resource(self):
        test = "test_opentargets_no_specified_resource"
        expected_result = ot_dict[test]["expected_result"]
        result_to_test = opentargets(**ot_dict[test]["args"])
        # If result is a DataFrame, convert to list
        if isinstance(result_to_test, pd.DataFrame):
    ...
    def test_opentargets_drugs_no_limit(self):
        test = "test_opentargets_drugs_no_limit"
        expected_result = ot_dict[test]["expected_result"]
        result_to_test = opentargets(**ot_dict[test]["args"])
        # If result is a DataFrame, convert to list
        if isinstance(result_to_test, pd.DataFrame):
    ...
    def test_opentargets_tractability(self):
        test = "test_opentargets_tractability"
        expected_result = ot_dict[test]["expected_result"]
        result_to_test = opentargets(**ot_dict[test]["args"])
        # If result is a DataFrame, convert to list
        if isinstance(result_to_test, pd.DataFrame):
    ...
    def test_opentargets_pharmacogenetics(self):
        test = "test_opentargets_pharmacogenetics"
        expected_result = ot_dict[test]["expected_result"]
        result_to_test = opentargets(**ot_dict[test]["args"])
    ...
    def test_pharmacogenetics_no_limit(self):
        test = "test_pharmacogenetics_no_limit"
        expected_result = ot_dict[test]["expected_result"]
        result_to_test = opentargets(**ot_dict[test]["args"])
        # If result is a DataFrame, convert to json (nested dataframes prevent easy listification)
        if isinstance(result_to_test, pd.DataFrame):
    ...
    def test_expression_no_limit(self):
        test = "test_expression_no_limit"
        expected_result = ot_dict[test]["expected_result"]
        result_to_test = opentargets(**ot_dict[test]["args"])
        # If result is a DataFrame, convert to list
        if isinstance(result_to_test, pd.DataFrame):
    ...
    def test_interactions_no_limit(self):
        test = "test_interactions_no_limit"
        expected_result = ot_dict[test]["expected_result"]
        result_to_test = opentargets(**ot_dict[test]["args"])
        # If result is a DataFrame, convert to list
        if isinstance(result_to_test, pd.DataFrame):
    ...
    def test_error_opentargets_bad_resource(self):
        test = "error_test1"
        with self.assertRaises(ValueError):
            opentargets(**ot_dict[test]["args"])

    def test_error_opentargets_bad_limit(self):
        test = "error_test2"
        with self.assertRaises(RuntimeError):
            opentargets(**ot_dict[test]["args"])

    def test_error_opentargets_nonexistent_id(self):
        test = "error_test3"
        with self.assertRaises(ValueError):
            opentargets(**ot_dict[test]["args"])

    def test_error_opentargets_tractability_limit(self):
        test = "error_test4"
        with self.assertRaises(ValueError):
            opentargets(**ot_dict[test]["args"])
