...
if __name__ == "__main__":
    ...
    output_fasta_dir = os.path.join(base_dir, 'mutant_reference_EXP', f'GRCh{grch_number}')   #!!! replace mutant_reference_EXP with mutant_reference
    ...
    good_mutations = total_mutations - intronic_mutations - unknown_mutations
