...
#         }
#         """,
#         "drug and clinical candidates",
#         [
#             # Drug data
#             ("drug_id", "drug.id"),
#             ("drug_name", "drug.name"),
#             ("drug_type", "drug.drugType"),
#             ("mechanism_of_action", "drug.mechanismsOfAction.rows"),
#             ("description", "drug.description"),
#             ("synonyms", "drug.synonyms"),
#             ("trade_names", "drug.tradeNames"),
#             ("max_clinical_stage", "drug.maximumClinicalStage"),

#             # Disease data (note: list)
#             ("disease_ids", "diseases.disease.id"),
#             ("disease_names", "diseases.disease.name"),
#         ],
#         ["description", "synonyms", "trade_names"],
#         _limit_deferred,
#         user_filter=_mk_filter_applicator({"disease_id": "diseases.disease.id"}),
#     ),
