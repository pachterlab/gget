...
<table style="width:100%; table-layout:fixed;">
  ...
  <tr>
    ...
    <td style="width:33.33%; padding:20px; text-align:center; vertical-align:top;"><a href="/gget/en/virus.md"><strong>gget virus</strong></a><br>Filter and get Viral Sequences and metadata from NCBI Virus Dataset.</td>
    <td style="width:33.33%; padding:20px; text-align:center; vertical-align:top;"><a href="/gget/en/8cubedb.md"><strong>gget 8cubedb</strong></a><br>Query 8cubeDB for gene-level specificity metrics and normalized expression values.</td>
  </tr>
</table>
