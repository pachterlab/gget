...
<img src="https://github.com/pachterlab/gget/blob/main/figures/gget_overview.png?raw=true)" float= "center" margin= "5px" width= 50% height= 50%  flex-direction=column> 
